...
def take_input_rider():
    ...
    currentdate = datetime.datetime.strptime(currentdate, "%d/%m/%Y").date() #This works but the error handling is attrocious. 
...
def show_help():
    print ("You can: ")
    print ("\nAdd a rider's data to the database")
    print ("\nAdd a horses' data to the database")
